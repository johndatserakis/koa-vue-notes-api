...
var _UserActionController = require('../controllers/UserActionController');
...
router.post('/api/v1/user/signup', function () {
    var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(ctx, next) {
        var userActionController;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        userActionController = new _UserActionController2.default();
                        _context2.next = 3;
                        return userActionController.signup(ctx);
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        userActionController = new _UserActionController2.default();
                        _context3.next = 3;
                        return userActionController.authenticate(ctx);
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        userActionController = new _UserActionController2.default();
                        _context4.next = 3;
                        return userActionController.refreshAccessToken(ctx);
            ...
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        userActionController = new _UserActionController2.default();
                        _context5.next = 3;
                        return userActionController.invalidateAllRefreshTokens(ctx);
            ...
            while (1) {
                switch (_context6.prev = _context6.next) {
                    case 0:
                        userActionController = new _UserActionController2.default();
                        _context6.next = 3;
                        return userActionController.invalidateRefreshToken(ctx);
            ...
            while (1) {
                switch (_context7.prev = _context7.next) {
                    case 0:
                        userActionController = new _UserActionController2.default();
                        _context7.next = 3;
                        return userActionController.forgot(ctx);
            ...
            while (1) {
                switch (_context8.prev = _context8.next) {
                    case 0:
                        userActionController = new _UserActionController2.default();
                        _context8.next = 3;
                        return userActionController.checkPasswordResetToken(ctx);
            ...
            while (1) {
                switch (_context9.prev = _context9.next) {
                    case 0:
                        userActionController = new _UserActionController2.default();
                        _context9.next = 3;
                        return userActionController.resetPassword(ctx);
            ...
            while (1) {
                switch (_context10.prev = _context10.next) {
                    case 0:
                        userActionController = new _UserActionController2.default();
                        _context10.next = 3;
                        return userActionController.private(ctx);
